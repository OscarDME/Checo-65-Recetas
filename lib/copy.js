...
export const copy = {
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Sleva více než 80 % pouze dnes" },
    ],
  },
  ...
  finalCta: {
    ...
    subUrgency:
      "Nenechte si ujít příležitost získat tuto kuchařku se slevou více než 80 %. Změňte své zdraví hned teď s naším kompletním menu na 365 dní.",
    ...
    discountBadge: "SLEVA VÍCE NEŽ 80 %",
  ...
  faq: {
    ...
    doesntWorkHeadline: "CO NEFUNGUJE: ❌",
    doesntWork: [
    ...
    items: [
      ...
      { q: "MOHU SI KUCHAŘKU PROHLÍŽET I NA TELEFONU?", a: "Ano, k receptům budete mít přístup z telefonu, tabletu i počítače." },
      { q: "MÁTE NĚJAKÉ DOTAZY?", a: "Ano, v průběhu procesu se na mě můžete kdykoliv napřímo obrátit s jakýmikoliv dotazy." },
      { q: "JAK DLOUHO BUDU MÍT K RECEPTŮM PŘÍSTUP?", a: "K veškerému obsahu získáte doživotní přístup." },
    ],
  },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Všechna práva vyhrazena. Seznamte se s našimi Zásadami ochrany osobních údajů.",
  },
};